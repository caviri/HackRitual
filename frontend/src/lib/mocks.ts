...
const DRAFT: StageData = {
  ...
  ritualLog: [
    ...
    { ts: '09:15:31', actor: 'tomas.k', verb: 'inscribed the tracks' },
...
const FROZEN: StageData = {
  ...
  proposals: [
    PROPOSALS_OPEN[0],
    { id: 7, title: 'lichen-loom', track: 'small-tools', blurb: 'a weave of cron jobs that schedule themselves around weather.', body: 'A scheduler that listens to weather feeds and decides when to run.', proposer: 'weft', team: 'weft', versions: 2, imageVariant: 'lattice' },
    PROPOSALS_OPEN[1],
  ],
  proposalsHeading: 'submissions under review',
  proposalsSeeAll: { label: 'all 14 submissions →', href: '/submissions/' },
  participants: [
    { handle: 'judge.aram', displayName: 'Aram J.', kind: 'human', meta: 'judge · data-science', affiliation: 'Stanford', imageVariant: 'sprout' },
    { handle: 'judge.mila', displayName: 'Mila A.', kind: 'human', meta: 'judge · infra', affiliation: 'ETH', imageVariant: 'sprout' },
    { handle: 'judge.theo', displayName: 'Theo R.', kind: 'human', meta: 'judge · small-tools', affiliation: 'Tokyo', imageVariant: 'sprout' },
  ],
...
const FINAL_PROPOSALS: ProposalMock[] = [
  ...
  { id: 7, title: 'lichen-loom', track: 'small-tools', blurb: 'a weave of cron jobs that schedule themselves around weather.', body: 'A scheduler that listens to weather feeds.', proposer: 'weft', team: 'weft', versions: 2, rank: 2, score: 89.8, imageVariant: 'lattice' },
...
const FINAL: StageData = {
  ...
  ritualLog: [
    ...
    { ts: '17:48:01', actor: 'system', verb: 'first place:', object: 'the_owls / mycelium-mesh', tone: 'primary' },
    { ts: '17:48:02', actor: 'system', verb: 'second place:', object: 'weft / lichen-loom' },
    { ts: '17:48:03', actor: 'system', verb: 'third place:', object: 'photosym / photosym-os' },
...
const ARCHIVED: StageData = {
  ...
  participants: FINAL.participants.map((p) => ({ ...p, meta: 'archived' })),
